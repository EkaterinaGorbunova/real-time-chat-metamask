  ...
  return (
    <div className="container mx-auto pt-24 md:pt-28">
      <div className="max-w-2xl mx-auto px-6 pb-12 text-center">
        <div className="relative bg-[color:var(--surface)]/80 backdrop-blur-xl rounded-2xl p-8 border border-[color:var(--border)]">
          ...
          <h2 className="text-2xl font-semibold tracking-tight text-[color:var(--text)] mb-3">
            Chat service is unavailable
          </h2>
          <p className="text-[color:var(--text-muted)] mb-2 text-sm">
            The chat cannot be started because the Ably API key is not configured.
          </p>
          <p className="text-[color:var(--text-subtle)] text-sm">
            Please set the{' '}
            <code className="px-1.5 py-0.5 bg-[color:var(--surface-muted)] border border-[color:var(--border)] rounded text-rose-400">
              ABLY_API_KEY
            </code>{' '}
